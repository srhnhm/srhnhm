...
var userData = {
	...
	"ImageURLUser":  filepath+"/images/imgs/sample-user-photo.png",
	"ImageURLCar": filepath+"/images/imgs/sample-user-car.png", 
	"ImageURLLicense":  filepath+"/images/imgs/sample-user-license.jpg",
...
function initFields(data) {
	...
	function confirmSaved(obj) {
		$(obj).after('<label class="saved-label" style="display:inline">Saved...</label>');
